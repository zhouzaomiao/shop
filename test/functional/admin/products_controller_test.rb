...
class Admin::ProductsControllerTest < ActionController::TestCase
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post :create, admin_product: { cost: @admin_product.cost, count: @admin_product.count, describe: @admin_product.describe, name: @admin_product.name, price: @admin_product.price, price_url: @admin_product.price_url }
    end
  ...
  test "should update admin_product" do
    put :update, id: @admin_product, admin_product: { cost: @admin_product.cost, count: @admin_product.count, describe: @admin_product.describe, name: @admin_product.name, price: @admin_product.price, price_url: @admin_product.price_url }
    assert_redirected_to admin_product_path(assigns(:admin_product))
  end
